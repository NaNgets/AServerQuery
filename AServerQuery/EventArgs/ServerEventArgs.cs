// ServerEventArgs.cs is part of AServerQuery.
//
...
namespace AServerQuery
{
    ...
    public class ServerEventArgs : GoldSrcEventArgs
    {
        #region Properties
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AServerQuery.ServerEventArgs" /> class using
