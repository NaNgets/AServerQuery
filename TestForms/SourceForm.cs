...
namespace TestForms
{
    public partial class SourceForm : Form
    {
        ...
        {
            server = new SourceServer(new System.Net.IPEndPoint(IPAddress.Parse(this.txtIPort.Text.Split(':')[0]), int.Parse(this.txtIPort.Text.Split(':')[1])), String.Empty);
        ...
        {
            bool value = this.server.ConnectRcon();
            this.txtConsole.AppendText(String.Format("Rcon connected: {0}{1}", value, Environment.NewLine));
        }

        private void btnDisconnectRcon_Click(object sender, EventArgs e)
        {
            this.server.DisconnectRcon();
            this.txtConsole.AppendText(String.Format("Rcon Disconnected{0}", Environment.NewLine));
        }
        ...
        {
            this.txtConsole.AppendText(String.Format("{0}{1}", this.server.QueryRcon(this.txtRcon.Text).Replace("\n", Environment.NewLine), Environment.NewLine));
        }
